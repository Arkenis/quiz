        ...
        <div class="content">
            ...
            <div class="container-fluid container-fixed-lg">
                ...
                <ul class="breadcrumb">
                    ...
                    <li>
                        <a href="#" class="active">Ulanyjylaryň tertibi</a>
                    </li>
                </ul>
                <!-- END BREADCRUMB -->
            </div>
            ...
            <div class="container-fluid container-fixed-lg">
                ...
                <div class="panel panel-transparent">
                    <div class="panel-heading">
                        <div class="panel-title">Ulanyjylar
                        </div>
                    </div>
                        ...
                        <div class="panel-body">
                            ...
                            <a href="{{ URL::route('users.create') }}">
                                <button class="btn btn-success btn-cons m-b-10" type="button">
                                    ...
                                    <span class="bold">Täze ulanyjy goş</span>
                                </button>
                            </a>
                            ...
                            <div class="table-responsive">
                                <div id="basicTable_wrapper" class="dataTables_wrapper form-inline no-footer">
                                  <table class="table table-hover dataTable no-footer" id="basicTable" role="grid">
                                    <thead>
                                    <tr role="row">
                                        <th style="width: 25%;" tabindex="1" aria-controls="basicTable" rowspan="1" colspan="1">Ady</th>
                                        <th style="width: 15%;" tabindex="2" aria-controls="basicTable" rowspan="1" colspan="1">Login</th>
                                        <th style="width: 15%;" tabindex="2" aria-controls="basicTable" rowspan="1" colspan="1">Ulanyjynyñ görnüşi</th>
                                        <th style="width: 15%;" tabindex="2" aria-controls="basicTable" rowspan="1" colspan="1">Döredilen wagty</th>
                                        <th style="width: 15%;" tabindex="2" aria-controls="basicTable" rowspan="1" colspan="1">Üýtgedilen wagty</th>
